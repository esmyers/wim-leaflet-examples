		...
		success: function (geojson) {
			...
			var geojsonLayer = L.geoJson(geojson, {
				style: function (feature) {
					...
					//Baro
					if (feature.properties.SENSOR_TYPE_ID == 1 && feature.properties.DEPLOYMENT_TYPE_ID == 3) {
						return {color: '#FFFF00'};
					}
					//meteorological
					if (feature.properties.SENSOR_TYPE_ID == 2) {
						return {color: '#FFC0CB'};
					}
					//rapid deploy gage
					if (feature.properties.SENSOR_TYPE_ID == 5) {
						return {color: '#32BF32'};
					}
					//storm tide
					if (feature.properties.SENSOR_TYPE_ID == 1 && feature.properties.DEPLOYMENT_TYPE_ID == 1 || feature.properties.DEPLOYMENT_TYPE_ID == 2) {
						return {color: '#FF0000'};
					}
					//wave height
					if (feature.properties.SENSOR_TYPE_ID == 1 && feature.properties.DEPLOYMENT_TYPE_ID == 1) {
						return {color: '#800080'};
					}
